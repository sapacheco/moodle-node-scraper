...
// PARÁMETROS
// AUN NO PROGRAMADO 🤖: const _enumerarCarpetasDescargadas = true; // [bool, def: true]. Agregar un número a cada nombre de carpeta según su disposición en el aula virtual.
...
(async () => {
	...
	try {
		...
		await page.goto(_personalData["login-url"], { waitUntil: 'networkidle2' });
	...
	async function tryLogin () {
		...
		loginCookie = await page.cookies();
		...
		if (loginCookie[0].value !== navigationCookie[0].value) {
